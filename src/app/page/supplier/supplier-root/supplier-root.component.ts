...
@Component({
  ...
  imports: [AddPreviousComponent, PhotographerPackagesComponent,RatingReviewsComponent,ViewPreviousWorkComponent,ProfileViewComponent,BookingEventComponent],
